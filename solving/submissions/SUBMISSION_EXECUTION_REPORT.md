...
| --- | --- | --- | --- | --- |
| Easy | `experiments/2026-08-04_easy_serial_recurrent/submission.py` | 21,152-state LSD-aware tied recurrent prompt cell | e1: 0.00% test, 1.00% OOD, 0.50% mean | Rejected; do not resubmit |
...
This is overfit, not an optimization shortfall: Fable’s training exactness is
92.8% while both held-out splits are exactly zero. The recurrent-transfer
candidate also improves training fit without gaining reliable held-out exactness.
