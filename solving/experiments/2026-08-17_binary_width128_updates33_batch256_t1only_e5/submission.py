"""Binary fused work-state recurrence: width 128, 33 updates, tuned Muon.
...
BITS, WORKSPACE_BITS, CHANNELS, LANES, UPDATES = 11, 22, 128, 4, 33
T1_FRACTION, T1_WEIGHT = 1.00, 4.0
