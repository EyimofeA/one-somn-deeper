"""Local exact-square reducer with zero-initialized learned fast-message gates."""
...
class LearnedMessageBinaryWorkState(base.BinaryWorkState):
    ...
    def forward(
        ...
        for step in range(self.updates):
            ...
            if step % 4 == 3:
                ...
                visible = visible + self.fast_message_scales[gate_index] * shifted_pair(
                    visible, distances[gate_index]
                )
                message_index += 1
...
base.BinaryWorkState = LearnedMessageBinaryWorkState
