...
6. **Keep Easy e1 + e5** as the gate pair. Paper ideas go in `learnings/papers/` first.
7. T²MLR (arXiv 2607.15178) — log + midloop adaptation idea; don’t burn quota until greenlit.
